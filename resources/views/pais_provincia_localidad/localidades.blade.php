...
<div class="card">
    <div class="card-header">Localidades
                ...
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        <a class="btn btn-light btn-sm" href="#"
                            onclick="modalModificacion('{{$localidad->localidad}}')">Editar</a>
                        <a class="btn btn-danger btn-sm text-white delete" val-palabra={{$localidad->id}}>Borrar</a>
                        @endif
                    </td>
                </tr>
                @endforeach
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col">
                        <div class="form-group ">
                            <label for="provincia">Nombre de la Localidad</label>
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group ">
                            <label for="pais" class="">Provincia</label>
