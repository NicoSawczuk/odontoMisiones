...
@section('content')
<form class="form-group " method="POST" action="{{route("partes.update",$parte->id)}}">
    @method('PUT')
        ...
        <div class="card-body">
                ...
                <div class="col">
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control  @error('marca') is-invalid @enderror" id="marca"
                            name="marca" value="{{ old('marca') ?? $parte->marca}}" placeholder="Especifique su marca" required>
                        @error('marca')
                ...
                <div class="col">
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control  @error('modelo') is-invalid @enderror" id="modelo"
                            name="modelo" value="{{ old('modelo') ?? $parte->modelo}}" placeholder="Especifique sus modelo"
                            required>
                        @error('modelo')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                ...
                <div class="col-2">
                    <div class="form-group ">
                        ...
                        <input type="date" class="form-control  @error('fecha_garantia') is-invalid @enderror"
                            id="fecha_garantia" name="fecha_garantia" value="{{ old('fecha_garantia') ?? $parte->fecha_garantia}}"
                ...
                <div class="col-4">
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control  @error('numeros_serie') is-invalid @enderror" id="numeros_serie"
                            name="numeros_serie" value="{{ old('numeros_serie') ?? $parte->numeros_serie}}" placeholder="Especifique los numeros de serie" required>
                        @error('numeros_serie')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-2">
                    <div class="form-group ">
                        ...
                        <select name="estado" id="estado" class="form-control" required>
                            ...
                            <option value="NUEVO" @if(("NUEVO" == old('estado')) || ("NUEVO" == $parte->estado)) selected
                                @endif>NUEVO</option>
                            <option value="USADO"  @if(("USADO" == old('estado')) || ("USADO" == $parte->estado)) selected
                            @endif>USADO</option>
                            <option value="REFACCIONADO"  @if(("REFACCIONADO" == old('estado')) || ("REFACCIONADO" == $parte->estado)) selected
                ...
                <div class="col-3">
                    <div class="form-group ">
                        ...
                        <input type="number" class="form-control  @error('precio_sugerido') is-invalid @enderror" id="precio_sugerido"
                            name="precio_sugerido" value="{{ old('precio_sugerido') ?? $parte->precio_sugerido }}" placeholder="Especifique el precio sugerido"
                            required>
                ...
                <div class="col-6">
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control  @error('comprobante_asociado') is-invalid @enderror" id="comprobante_asociado"
                            name="comprobante_asociado" value="{{ old('comprobante_asociado') ?? $parte->comprobante_asociado }} " placeholder="Especifique su comprobante"
                            required>
            ...
            <div class="form-group ">
                ...
                <textarea name="notas_generales" id="notas_generales" cols="30" rows="10" class="form-control"
                    placeholder="Ingrese las notas particulares">{{ old('notas_generales') ?? $parte->notas_generales }}</textarea>
            </div>
        </div>
